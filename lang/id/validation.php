...
return [
    ...
    | validasi. Beberapa aturan memiliki banyak versi seperti aturan ukuran.
    ...
    */
    ...
    'password' => [
        ...
        'symbols' => 'Kolom :attribute harus mengandung setidaknya satu simbol atau karakter khusus.',
        'uncompromised' => 'Kolom :attribute yang dimasukkan terindikasi pernah bocor dalam kebocoran data. Silakan pilih :attribute yang lain.',
    ],
    ...
    'size' => [
        'array' => 'Kolom :attribute harus berisi :size anggota.',
    ...
    | konvensi "attribute.rule" untuk menamai barisnya. Hal ini memudahkan untuk
    | menentukan pesan bahasa kustom tertentu untuk aturan atribut yang diberikan.
    |
    */

    'custom' => [
        'password' => [
            'mixed' => 'Password harus mengandung kombinasi huruf besar dan huruf kecil.',
            'letters' => 'Password harus mengandung setidaknya satu huruf.',
            'numbers' => 'Password harus mengandung setidaknya satu angka.',
            'symbols' => 'Password harus mengandung setidaknya satu simbol atau karakter khusus.',
            'min' => 'Password minimal harus 8 karakter.',
            'confirmed' => 'Konfirmasi password tidak cocok dengan password yang dimasukkan.',
        ],
    ],
