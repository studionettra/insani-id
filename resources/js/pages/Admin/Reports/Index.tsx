        ...
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Laporan & Ekspor Data</h1>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Unduh laporan transaksi dalam format CSV untuk diolah lebih lanjut.</p>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm overflow-hidden">
                        <div className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 py-4 px-6">
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Unduh data seluruh donasi yang berstatus lunas (Paid).</p>
                        </div>
